...
This is the web backend powered by [ExpressJS](https://expressjs.com/) with the basic infrastructure for a JSON API with MongoDB persistency with [Mongoose](https://mongoosejs.com/).
