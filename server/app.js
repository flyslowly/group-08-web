...
var holidaysController = require('./controllers/holidays');

// Variables
var mongoURI = process.env.MONGODB_URI || 'mongodb+srv://7yeahslv:35D9WtdFSABFzTqE@cluster0-tp8ne.mongodb.net/calendar?retryWrites=true&w=majority';
...
app.get('/api', function(req, res) {
    res.json({'message': 'Welcome to this stupid calender project - Chenyu, Haoyang, Xiang!'});
});
